...
theme.set_highlights = function()
  ...
  hl(0, "CurSearch", { fg = 'NONE', bg = '#285c7a' })
  ...
  hl(0, "TabLine", { fg = c.fg, bg = c.alt_bg })
  hl(0, "TabLineSel", { fg = c.light_gray, bg = c.dark_gray })
  hl(0, "TabLineFill", { fg = c.fg, bg = c.bg })
  hl(0, 'WinBar', { fg = c.fg, bg = c.bg, bold = true })
  hl(0, 'WinBarNc', { fg = c.fg, bg = c.bg })
  ...
  hl(0, "Module", { fg = c.cyan, bg = 'NONE' })
  hl(0, "Function", { fg = c.yellow, bg = 'NONE' })
  hl(0, "Keyword", { fg = c.blue, bg = 'NONE' })
  hl(0, "Coroutine", { fg = c.purple, bg = 'NONE' })
  ...
  hl(0, "Return", { fg = c.purple, bg = 'NONE' })
  ...
  hl(0, "@module", { link = 'Module' })
  hl(0, "@module.builtin", { link = 'Module' })
  ...
  hl(0, "@string.special.url", { fg = c.orange, bg = 'NONE', underline = true })
  ...
  hl(0, "@keyword.coroutine", { link = 'Coroutine' })
  ...
  hl(0, "@keyword.return", { link = 'Return' })
  ...
  hl(0, "@attribute.builtin", { fg = c.cyan })
  ...
  hl(0, "@variable.parameter.builtin", { fg = c.blue, bg = 'NONE' })
  ...
  -- snacks.nvim indent
  hl(0, "SnacksIndentScope", { fg = '#e4e4e4', bg = 'NONE' })
  hl(0, "SnacksIndent", { fg = c.alt_bg, bg = 'NONE' })
